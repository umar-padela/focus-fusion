...
class SegmentationHead(nn.Module):
    """Two-layer MLP per-point head with optional intermediate dropout.

    Args:
        d_in: Input feature dimension (must match CrossAttentionFusion output).
        num_classes: Number of semantic classes (32 for nuScenes lidarseg).
        hidden_dim: Hidden layer width. If None, uses a single linear layer.
